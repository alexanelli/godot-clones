...
static var TETR_INFO_I: StaticTetrominoInfo = StaticTetrominoInfo.new(
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0), Vector2i(2, 0)),
        [Vector2i(0, 0), Vector2i(-1, 0), Vector2i(2, 0), Vector2i(-1, 0), Vector2i(2, 0)]
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 1), Vector2i(0, 0), Vector2i(0, -1), Vector2i(0, -2)),
        [Vector2i(-1, 0), Vector2i(0, 0), Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, -2)]
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-2, 0), Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0)),
        [Vector2i(-1, 1), Vector2i(1, 1), Vector2i(-2, 1), Vector2i(1, 0), Vector2i(-2, 0)]
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 2), Vector2i(0, 1), Vector2i(0, 0), Vector2i(0, -1)),
...
static var TETR_INFO_J: StaticTetrominoInfo = StaticTetrominoInfo.new(
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 1), Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0)),
        JLSTZ_Offsets.slice(0, 5)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(1, 1), Vector2i(0, 1), Vector2i(0, 0), Vector2i(0, -1)),
        JLSTZ_Offsets.slice(5, 10)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0), Vector2i(1, -1)),
        JLSTZ_Offsets.slice(10, 15)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, -1), Vector2i(0, -1), Vector2i(0, 0), Vector2i(0, 1)),
        JLSTZ_Offsets.slice(15, 20)
    ),
    Kind.J,
)
...
static var TETR_INFO_L: StaticTetrominoInfo = StaticTetrominoInfo.new(
    ...
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 1), Vector2i(0, 0), Vector2i(0, -1), Vector2i(1, -1)),
        JLSTZ_Offsets.slice(5, 10)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, -1), Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0)),
...
static var TETR_INFO_S: StaticTetrominoInfo = StaticTetrominoInfo.new(
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 0), Vector2i(0, 0), Vector2i(0, 1), Vector2i(1, 1)),
        JLSTZ_Offsets.slice(0, 5)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 1), Vector2i(0, 0), Vector2i(1, 0), Vector2i(1, -1)),
        JLSTZ_Offsets.slice(5, 10)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, -1), Vector2i(0, -1), Vector2i(0, 0), Vector2i(1, 0)),
        JLSTZ_Offsets.slice(10, 15)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 1), Vector2i(-1, 0), Vector2i(0, 0), Vector2i(0, -1)),
        JLSTZ_Offsets.slice(15, 20)
    ),
    Kind.S,
)
...
static var TETR_INFO_Z: StaticTetrominoInfo = StaticTetrominoInfo.new(
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 1), Vector2i(0, 0), Vector2i(0, 1), Vector2i(1, 0)),
        JLSTZ_Offsets.slice(0, 5)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, -1), Vector2i(0, 0), Vector2i(1, 0), Vector2i(1, 1)),
    ...
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 0), Vector2i(0, -1), Vector2i(0, 0), Vector2i(1, -1)),
        JLSTZ_Offsets.slice(10, 15)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, -1), Vector2i(-1, 0), Vector2i(0, 0), Vector2i(0, 1)),
...
static var TETR_INFO_T: StaticTetrominoInfo = StaticTetrominoInfo.new(
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0), Vector2i(0, 1)),
        JLSTZ_Offsets.slice(0, 5)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, -1), Vector2i(0, 0), Vector2i(0, 1), Vector2i(1, 0)),
        JLSTZ_Offsets.slice(5, 10)
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(-1, 0), Vector2i(0, 0), Vector2i(1, 0), Vector2i(0, -1)),
...
static var TETR_INFO_O: StaticTetrominoInfo = StaticTetrominoInfo.new(
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 0), Vector2i(0, 1), Vector2i(1, 0), Vector2i(1, 1)),
        [Vector2i(0, 0)]
    ),
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 0), Vector2i(0, -1), Vector2i(1, 0), Vector2i(1, -1)),
    ...
    PieceOrientation.new(
        PieceShape.new(Vector2i(0, 0), Vector2i(-1, 0), Vector2i(0, 1), Vector2i(-1, 1)),
        [Vector2i(-1, -1)]
    ),
    Kind.O,
)
